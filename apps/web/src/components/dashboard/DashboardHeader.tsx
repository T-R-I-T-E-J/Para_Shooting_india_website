...
const DashboardHeader = ({ title, subtitle }: DashboardHeaderProps) => {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Remove any client-side cookie remnants
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:block relative">
            <Search aria-hidden="true" className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-400" />
            <input
              type="search"
              name="search"
              autoComplete="off"
          ...
          <div className="relative">
            ...
            >
              <div className="w-8 h-8 bg-neutral-100 rounded-full flex items-center justify-center">
                <User aria-hidden="true" className="w-4 h-4 text-neutral-400" />
              </div>
              <ChevronDown aria-hidden="true" className="w-4 h-4 text-neutral-400" />
            </button>
